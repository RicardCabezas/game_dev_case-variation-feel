...
namespace Game.GamePlay.Heroes
{
    ...
    public readonly struct HeroHitResult
    {
        ...
        /// <summary>Gets hero world position when damage is applied.</summary>
        ...
        /// <param name="position">Hero world position when damage is applied.</param>
        /// <param name="isLethal">Whether applied damage reduced health to zero.</param>
        public HeroHitResult(int damage, int remainingHealth, Vector3 position, bool isLethal)
        {
            Damage = damage;
