...
namespace Game.UI
{
    ...
    {
        [SerializeField]
        private HealthBarView healthBarPrefab;
        ...
        [SerializeField]
        private Vector3 heroWorldOffset = new Vector3(0f, 1.5f, 0f);

        [SerializeField]
        private Vector3 enemyWorldOffset = new Vector3(0f, 1.5f, 0f);

        [SerializeField]
        private float fillSmoothDuration = 0.15f;

        private IHealthBarsPresentationSource _controller;
        ...
        {
            _controller = ServicesLocator.Instance.GetService<HealthBarsService>().Presentation;
            ...
            var capacity = Mathf.Max(1, WavesConfig.Instance.MaximumConcurrentEnemies + 1);
        ...
        private void OnHealthBarAdded(HealthBarState state)
        {
            ...
            Vector3 worldOffset =
                state.Id.Owner == HealthBarOwner.Hero ? heroWorldOffset : enemyWorldOffset;
